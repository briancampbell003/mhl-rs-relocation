export const duringData = [
    {
      title: '(3.1) Wellbeing checks for high-risk clients',
      content: `With your tenants out of the property, you are now fully in the relocation part of the
      ...
      staff to set-up shop. I had created a Google Voice number to communicate with residents from my
      cell phone (without using my actual cell phone number) and arranged for them to meet me
      downstairs as needed.
      You may in your regular Case Manager duties have certain residents that have achieved some
      self-sufficiency and do not engage much with Resident Services at your property. Just like under
      normal conditions, these residents should handle relocation without incident, although you may
      ...
      relocation, particularly if they are consistently unavailable by telephone. One man from the Carlton
      ...
      Of course, the specific needs of your tenants may be different.`
    },
    {
      title: '(3.2) Form a relationship with outside housing provider management when possible',
      content: `For the duration of the construction project, your tenants will have two property managers. On
      the one hand, they will still be tenants with MHL and pay rent to the PM team for your property,
      and (at least on paper) be expected to follow the House Rules laid out in the MHL lease. However,
      they will be physically living at a different location with a different management team, and that
      team will be doing their best to ensure safe and equitable living conditions for all their tenants,
      ...
      I imagine this relationship will look very different based on the details of the specific property or
      properties where tenants are placed for relocation. On one extreme, all your MHL tenants might be
      in a large building that has a spare office space which the building management will allow you to use
      during business hours, where you can create a makeshift temporary office not so different from the
      ...
      building (about 300 units) in which the property manager graciously allowed RS staff to work from a
      
      table in the hallway across from the mailboxes. I would make myself available to tenants in this
      space three times a week, while working from a temporary office at the Miriam the rest of the time.`
    },
    {
      ...
      these residents that they would need to apply, the same way any other citizen would, for tenancy,
      ...
      would not be approved for an apartment that costs $900 per month. Moreover, applying for that
      ...
      new housing. It is best to be clear and straightforward in the requirement of returning to the Carlton
    ...
    },
    {
      ...
      renovation. This whole process, for the Carlton at least, went along rather smoothly from the point
      at which, during our weekly resyndication call, MHL Development introduced a representative for
      ...
      asked for our help in picking one artist for the job. Once landing on an artist, he reached out to us
