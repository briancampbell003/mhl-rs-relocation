export const afterData = [
    {
      ...
      come with its own set of challenges. Due to the pressures from funders and various tax incentives, it
      is at least possible that the renovated property will re-open and begin returning its tenants before
      the building is 100% complete and ready-for-use. As the on-site staff, it is the responsibility of RS
      ...
      other site staff from PM team) are the MHL employee that they see every day. Don’t take it
      personally.`
    },
    {
      title: '(4.2) Expect a speedy lease-up and prioritize responsibilities with supervisor',
      ...
      their moves back and handling some of the potential issues described above. During
      relocation the property may lose tenants through normal attrition (death, residents finding
      other housing opportunities, moving out-of-state) and so upon return the occupancy rate
      will be low. At the Carlton, this occupancy metric was tied to the renovation funding in such
      a way that the building needed to be 100% occupied within about 6 weeks of its reopening.
      ...
      making the intake friendly and conversational, while still hitting all the required questions
      for the paperwork.`
    },
    {
      ...
      Given the rushed lease-up process, we had various tenant applications and had to be
      prepared to move them in when they showed up. Two of the Friday tenants may have been
      “scheduled” to sign leases and move in on Wednesday and Thursday, but if they did not
      appear at their appointments but then showed up on Friday, we of course moved them in
